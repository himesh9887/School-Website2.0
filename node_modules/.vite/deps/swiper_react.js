...
function updateSwiper(args) {
  ...
  if (changedParams.includes("thumbs") && isObject(passedThumbs) && isObject(passedThumbs.swiper) && !passedThumbs.swiper.destroyed && isObject(currentThumbs) && (!currentThumbs.swiper || currentThumbs.swiper.destroyed)) {
    needThumbsInit = true;
  }
