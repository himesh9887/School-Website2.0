...
var Pagination = ({ swiper, extendParams, on, emit }) => {
  ...
  function render() {
    ...
    const slidesLength = isVirtualEnabled(swiper) ? swiper.virtual.slides.length : swiper.grid && (gridParams == null ? void 0 : gridParams.rows) && gridParams.rows > 1 ? swiper.slides.length / Math.ceil(gridParams.rows) : swiper.slides.length;
    const els = makeElementsArray(swiper.pagination.el);
    let paginationHTML = "";
